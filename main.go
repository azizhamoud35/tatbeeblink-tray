...
// Simple fallback icon (16x16 blue medical cross)
var fallbackIcon = []byte{
	0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A, 0x00, 0x00, 0x00, 0x0D, 0x49, 0x48, 0x44, 0x52,
	0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0x08, 0x06, 0x00, 0x00, 0x00, 0x1F, 0xF3, 0xFF,
	0x61, 0x00, 0x00, 0x00, 0x3F, 0x49, 0x44, 0x41, 0x54, 0x38, 0x8D, 0x63, 0x64, 0xC0, 0x0F, 0xF8,
	0xFF, 0xFF, 0xFF, 0x19, 0x46, 0x0C, 0x05, 0x05, 0x85, 0x81, 0x81, 0x81, 0x0C, 0x0C, 0x8C, 0xFF,
	0xFF, 0xFF, 0x7F, 0x06, 0x06, 0x06, 0x32, 0x30, 0x30, 0x30, 0xFE, 0xFF, 0xFF, 0xFF, 0x19, 0x18,
	0x18, 0xF8, 0x7F, 0x18, 0x50, 0x0C, 0xA2, 0x20, 0x14, 0x06, 0x00, 0x00, 0xFF, 0xFF, 0x15, 0x4E,
	0x1B, 0xC3, 0xC9, 0xCE, 0x5F, 0x1E, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E, 0x44, 0xAE, 0x42,
	0x60, 0x82,
}
...
func getIcon() []byte {
	// Use simple fallback icon for system tray (16x16 PNG works better)
	if len(fallbackIcon) > 0 {
		log.Printf("Using fallback icon for system tray")
		return fallbackIcon
	}

	// Try embedded icon
	if len(iconData) > 0 {
		log.Printf("Using embedded icon data")
		return iconData
	}

	// Last resort: Try to load from file system
